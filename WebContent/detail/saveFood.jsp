...
<body>
	...
	<div id="MainArea">
		<!-- 表单内容 -->
		<form action="../addf" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
			<!-- 本段标题（分段标题） -->
					...
					<div class="ItemBlock2">
						<table cellpadding="0" cellspacing="0" class="mainForm">
							...
							<tr>
								<td width="80px">菜名</td>
								<td>
									<input type="text" name="foodName" class="InputStyle" value="" /> 
							...
							<tr>
								<td>价格</td>
								<td>
									<input type="text" name="price" class="InputStyle" value="" /> *
								</td>
							</tr>
							<tr>
								<td>简介</td>
								<td><textarea name="desc" class="TextareaStyle"></textarea></td>
							</tr>
							<tr>
